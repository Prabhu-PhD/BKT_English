...
color_selector_gruppe = bkt.ribbon.Group(
    ...
    label='QuickEdit',
    supertip="Activates a small floating mini toolbar with an interactive color picker. The `ppt_quickedit` feature must be installed.",
        ...
        bkt.ribbon.SplitButton(
            ...
            children=[
                bkt.ribbon.Button(
                    ...
                    supertip="Shows the QuickEdit panel with the interactive color picker.",
                    on_action=bkt.Callback(QuickEditPanelManager.show_panel_for_active_window, context=True)
                ),
                bkt.ribbon.Menu(
                    label="QuickEdit panel menu",
                    children=[
                        bkt.ribbon.Button(
                            id="quickedit_button2",
                            image="qe_icon",
                            label="Show for this window",
                            supertip="Shows the QuickEdit panel with the interactive color picker.",
                            on_action=bkt.Callback(QuickEditPanelManager.show_panel_for_active_window, context=True)
                        ),
                        bkt.ribbon.Button(
                            label="Close for this window",
                            supertip="Closes the QuickEdit panel for the current PowerPoint window.",
                            on_action=bkt.Callback(QuickEditPanelManager.close_panel_for_active_window, context=True, presentation=True)
                        ),
                        bkt.ribbon.Button(
                            label="Close all",
                            supertip="Closes all QuickEdit panels for all PowerPoint windows.",
...
#                 show_label=False,
#                 supertip="Sets or selects the chosen color for background, line or text, depending on whether CTRL, SHIFT and ALT are held.\n\nIf the button is active, the color in the current selection is used as background and/or line.",
...
#                 show_label=False,
#                 supertip="Sets or selects shapes without fill for background, line or text, depending on whether CTRL, SHIFT and ALT are held.\n\nIf the button is active, the color in the current selection is used as background and/or line.",
...
#                 supertip="Add the background color of the selected shape to the recently used colors.",
...
#                 show_label=False,
#                 image_mso="PickUpStyle",
#                 supertip="Add the background color of the selected shape to the custom colors.",
...
#         bkt.ribbon.Box(box_style="vertical", children=[
#             bkt.ribbon.Label(label="[Shift]: selection"),
#             bkt.ribbon.Label(label="[Ctrl]: line"),
#             bkt.ribbon.Label(label="[Alt]: Text"),
#         ]),
#         bkt.ribbon.Box(box_style="horizontal", children=[
#             bkt.ribbon.Button(image_mso="Help", label="Help", show_label=False, on_action=bkt.Callback(QuickEdit.show_help)),
#             bkt.ribbon.Label(label=u"[Shift: selection | Ctrl: line | Alt: text]"),
#         ]),
#     ]
# )
