...
testfenster_gruppe = bkt.ribbon.Group(
    ...
    children = [
        bkt.ribbon.Button(
            id = 'colorwindow',
            label="Window with color picker",
            show_label=True,
            image_mso='HappyFace',
...
architecture_gruppe = bkt.ribbon.Group(
    ...
    children = [
        bkt.ribbon.Button(
            label="3 additional points per rectangle side",
            size="large",
            image_mso="ObjectEditPoints",
            screentip="Add 3 additional points for connectors to each rectangle side",
            supertip="Adds 3 additional shape points to each side that can be used for connectors. Works only with rectangles.",
    ...
    bkt.ribbon.Tab(
        ...
        children=[
            bkt.ribbon.FirstColumn(children=[
                bkt.ribbon.Group(label="test group", children=[
                            ...
                            children=[
                                bkt.ribbon.MenuGroup(
                                    ...
                                    children=[
                                        bkt.ribbon.Button(
                                            label="Test2",
                                            description="Description text bla bla",
                                            image_mso="HappyFace",
