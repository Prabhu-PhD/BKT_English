...
@bkt.configure(label='Align', uuid='a1d52fb5-a9e4-48ed-8b1c-c3f4c6f87462')  
@bkt.group
...
#    return Group(id='group_bkt_align', label='Align', children=children)
    
@bkt.configure(label='Order', uuid='843cd2d9-e81a-49d8-ac1a-888eb29d0deb')  
@bkt.group
...
@bkt.configure(label='Operations', uuid='e267a046-6132-4ebb-9ffc-4deccd9679b8')
@bkt.group
