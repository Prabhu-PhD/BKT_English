    ...
    def get_styles():
        def style_button(file):
            return bkt.ribbon.ToggleButton(
                label= file,
                screentip="Loading"+file,
                supertip="Load custom styles from this gallery file.",
        ...
        return bkt.ribbon.Menu(
            ...
            id=None,
            children=[
                bkt.ribbon.MenuSeparator(title="Manage style galleries"),
            ] + [
                style_button(file)
                ...
                bkt.ribbon.Button(
                    label='Create new style gallery',
                    supertip="Create a new gallery with a definable name.",
