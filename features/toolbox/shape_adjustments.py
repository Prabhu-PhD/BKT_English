...
adjustments_group = bkt.ribbon.Group(
    ...
    image_mso='ShapeArc',
    children=[
        # bkt.ribbon.Label(label="Round./points"),
        bkt.ribbon.ButtonGroup(#box_style="horizontal",
            children=[
                bkt.ribbon.Button(
                    label="⟨", #"#«",
                    screentip="Show previous handle values",
                    supertip="Jump to the previous page for the handle values.",
                ...
                bkt.ribbon.Menu(
                    ...
                    screentip="Switch handle values",
                    supertip="Handles affect the shape form, e.g. the rounding at corners or the tip of arrows. Depending on the shape type, there can be up to 8 handle values that can be set manually. Here you can toggle between the values in pairs.",
                    children = [
                        bkt.ribbon.MenuSeparator(title="Roundings/points/corners"),
                        bkt.ribbon.ToggleButton(
                            label="Values 1 and 2",
                            supertip="Adjust handle values no. 1 and 2 in spinner boxes",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Values 3 and 4",
                            supertip="Adjust handle values no. 3 and 4 in spinner boxes",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Values 5 and 6",
                            supertip="Adjust handle values no. 5 and 6 in spinner boxes",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Values 7 and 8",
                            supertip="Adjust handle values no. 7 and 8 in spinner boxes",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Toggle conversion",
                            # image_mso='ResetCurrentView',
                            supertip="Convert relative shape handle values into absolute values, or show original values.",
                        ...
                        bkt.ribbon.Button(
                            label="Reset all shapes",
                            image_mso='ResetCurrentView',
                            supertip="Reset the shape handle values for all selected shapes to the original values",
                            on_action=bkt.Callback(ShapeAdjustments.reset_adjustments, shapes=True),
                        ),
                        bkt.ribbon.Button(
                            label="Match all shapes",
                            image_mso='ShapeArc',
                            supertip="Match the shape handle values for all selected shapes to the first selected shape",
                            on_action=bkt.Callback(ShapeAdjustments.equalize_adjustments, shapes=True),
                        ),
                        bkt.ribbon.MenuSeparator(),
                        bkt.ribbon.Button(
                            label="Show shape details",
                            image_mso='PropertiesForm',
                            supertip="Shows a window with detailed information about the selected shape",
                ...
                bkt.ribbon.Button(
                    label="⟩", #"»",
                    screentip="Show next handle values",
                    supertip="Jump to the next page for the handle values.",
        ...
        bkt.ribbon.RoundingSpinnerBox(
            ...
            show_label=False,
            image_mso='ShapeArc',
            screentip="Width of rounding/arrowheads/corners/etc.",
            supertip="Change the width of roundings (e.g. rounded rectangle), arrowheads (e.g. directional arrow) or corners (e.g. snipped rectangle) to the specified value (in cm or %, depending on the shape type).",
