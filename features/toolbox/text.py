...
class Characters(object):
    ...
    typography = [
        ...
        (None, '\xb6', "Paragraph"),
        (None, '\u2026', "Auslassungspunkte (Ellipse)", "An ellipsis is three closely-spaced dots. It usually indicates an omission of part of the text."),
        (None, '\u2013', "Gedankenstrich (Halbgeviertstrich/En-Dash)", "An en dash (Halbgeviertstrich) as Office sometimes inserts automatically. Used as a range or distance dash."),
        ...
        (None, '\u2030', "Per mil"),
        (None, '\u20AC', "Euro"),
        (None, '\u1E9E', "Capital eszett (ẞ)"),
    ]

    ### MATH ###
    math = [
        (None, '\xb1',   "Plus-Minus-Zeichen", "Insert a plus-minus sign."),
        (None, '\u2212', "Echtes Minuszeichen", "Insert a true minus sign (not a hyphen)."),
        (None, '\xd7',   "Echtes Malzeichen (Kreuz)", "Insert a true cross multiplication sign."),
        (None, '\u22c5', "Echtes Malzeichen (Punkt)", "Insert a true dot multiplication sign."),
        (None, '\u2044', "Echter Bruchstrich", "Insert a true fraction slash (similar to a slash)."),
        (None, '\u2248', "Approximately equal", "Insert an approximately-equal sign."),
        (None, '\u2260', "Ungleich", "Insert a not-equal sign."),
        (None, '\u2206', "Delta", "Insert a delta sign."), #alt: \u0394 griechisches Delta
        (None, '\u2300', "Mittelwert/Durchmesser", "Insert a diameter / average sign."), #alt: \xD8 leere menge
        (None, '\u2211', "Summenzeichen", "Insert a summation sign."),
        (None, '\u221A', "Wurzelzeichen", "Insert a square-root sign."),
        (None, '\u221E', "Unendlich-Zeichen", "Insert an infinity sign (sideways eight)."),
        (None, '\u2264', "Kleiner-Gleich", "Insert a less-than-or-equal sign."),
        (None, '\u2265', "Greater-or-equal", "Insert a greater-than-or-equal sign."),
    ]

    ### LIST ###
    lists = [
        (None, '\u2022', "Bullet point (circle)", "Insert a bullet point (black dot)."),
        (None, '\u2023', "Bullet point (triangle)", "Insert a bullet point (black triangle)."),
        (None, '\u25AA', "Bullet point (square)", "Insert a bullet point (black square)."),
        (None, '\u2043', "Bullet point (dash)", "Insert a bullet point (hyphen)."),
        (None, '\u2212', "Echtes Minuszeichen", "Insert a true minus sign (not a hyphen)."),
        (None, '\x2b',   "Pluszeichen", "Insert a plus sign."),
        (None, '\u2610', "Box leer"),
        (None, '\u2611', "Box check mark"),
        (None, '\u2612', "Box Kreuzchen"),
        ...
        (None, '\u2713', "Check mark", "Insert a check-mark symbol."),
        (None, '\u2714', "Check mark bold", "Insert a bold check-mark symbol."),
        (None, '\u2717', "Kreuzchen geschwungen", "Insert a curved cross (matching the check mark)."),
        (None, '\u2718', "Kreuzchen geschwungen fett", "Insert a bold curved cross (matching the check mark)."),
        (None, '\u2715', "Kreuzchen symmetrisch", "Insert a symmetrical cross (similar to a multiplication sign)."),
        (None, '\u2716', "Kreuzchen symmetrisch fett", "Insert a bold symmetrical cross (similar to a multiplication sign)."),
        (None, '\u2605', "Stern schwarz"),
        (None, '\u2606', "Star white"),
        (None, '\u261B', "Zeigefinger schwarz"),
        (None, '\u261E', "Pointing finger white"),
        ...
        ("Wingdings",   '\xfc', "Wingdings check mark"),
    ]
    ...
    arrows = [
        ...
        (None, '\u2191', "Pfeil oben"),
        (None, '\u2193', "Pfeil unten"),
        (None, '\u2194', "Arrow left and right"),
        (None, '\u21C4', "Arrow left and right"),
        (None, '\u2197', "Pfeil rechts oben"),
        (None, '\u2196', "Pfeil links oben"),
        (None, '\u2198', "Pfeil rechts unten"),
        (None, '\u2199', "Pfeil links unten"),
        (None, '\u2195', "Arrow up and down"),
        (None, '\u21C5', "Arrow up and down"),
        (None, '\u21E8', "White arrow right"),
        (None, '\u21E6', "White arrow left"),
        (None, '\u21E7', "White arrow up"),
        (None, '\u21E9', "White arrow down"),
        (None, '\u21AF', "Blitz"),
        (None, '\u21BA', "Circular arrow counterclockwise"),
    ]
    ...
    def get_text_unicodefont(cls):
        def _unicode_font_button(font):
            return bkt.ribbon.ToggleButton(
                ...
                supertip=font+" — use as the Unicode font.",
