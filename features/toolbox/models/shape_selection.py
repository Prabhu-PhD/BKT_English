...
selection_menu = memoize(lambda: bkt.ribbon.Menu(
                ...
                id=None, 
                children=[
                    bkt.ribbon.MenuSeparator(title="Selection of shapes…"),
                    bkt.ribbon.Button(
                        id = 'shapes_form',
                        image_mso = 'GroupSmartArtQuickStyles',
                        label='…with the same form',
                        #show_label=False,
                        on_action=bkt.Callback(lambda context: ShapeSelector.selectByKeys(context, ['shape_type']), context=True),
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects with the same form",
                        supertip="Select all shapes on the current slide that have the same form as one of the selected shapes",
                    ),

                    bkt.ribbon.Button(
                        id = 'shapes_bg',
                        image_mso = 'ColorBlue',
                        label='…with the same background',
                        #show_label=False,
                    ...
                    bkt.ribbon.Button(
                        ...
                        label='…with the same font color',
                        #show_label=False,
                        on_action=bkt.Callback(lambda context: ShapeSelector.selectByKeys(context, ['font_color']), context=True),
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects with the same font color",
                        supertip="Select all shapes on the current slide that have the same font color as one of the selected shapes",
                    ),
                    ...
                    bkt.ribbon.Button(
                        ...
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects with the same text",
                        supertip="Select all shapes on the current slide that have the same text as one of the selected shapes",
                    ),

                    bkt.ribbon.Button(
                        id = 'shapes_size',
                        image_mso = 'ShowEmptyContainers',
                        label='…with the same size',
                        #show_label=False,
                        on_action=bkt.Callback(lambda context: ShapeSelector.selectByKeys(context, ['shape_width', 'shape_height']), context=True),
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects with the same size",
                        supertip="Select all shapes on the current slide that have the same size as one of the selected shapes",
                    ),
                    ...
                    bkt.ribbon.Button(
                        ...
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects by custom selection",
                        supertip="Open a dialog to select the shape properties by which the shapes on the current slide should be selected.",
                    ),
                    ...
                    bkt.ribbon.Button(
                        ...
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects overlapping with the chosen shapes",
                        supertip="Select all shapes on the current slide that overlap with one of the selected shapes.",
                    ),
                    bkt.ribbon.Button(
                        ...
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects within the chosen shapes",
                        supertip="Select all shapes on the current slide that are completely within one of the selected shapes.",
                    ),
                    bkt.ribbon.Button(
                        ...
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects within and above the chosen shapes",
                        supertip="Select all shapes on the current slide that are completely within and above (i.e. higher Z-order) one of the selected shapes.",
                    ),
                    bkt.ribbon.Button(
                        ...
                        get_enabled = bkt.apps.ppt_shapes_or_text_selected,
                        screentip="Select shape objects within and below the chosen shapes",
                        supertip="Select all shapes on the current slide that are completely within and below (i.e. lower Z-order) one of the selected shapes.",
                    ),

                    bkt.ribbon.MenuSeparator(title="Select"),
                    ...
                    bkt.ribbon.Button(
                        ...
                        supertip="Inverts the current selection. All shapes (including placeholders) that were not previously selected are selected.",
                    ),
                    bkt.ribbon.Button(
                        id = 'shapes_select_tags',
                        image_mso = 'FindTag',
                        label='Shapes with tags',
                        on_action=bkt.Callback(ShapeSelector.select_with_tags, context=True),
                        # get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                        supertip="Marks all shapes on the slide with tags (metadata) that are used among other things for various BKT functions.",
                    ),
                ]
            ))