...
sticker_menu = memoize(lambda: bkt.ribbon.Menu(
                ...
                children=[
                    bkt.ribbon.Button(
                        ...
                        label = "DRAFT sticker",
                        image = "Sticker",
                        screentip="Insert DRAFT sticker",
                        supertip="Insert a sticker shape in the top right of the current slide with the text DRAFT.",
                        on_action=bkt.Callback(TextShapes.add_sticker_to_slides, slides=True, presentation=True)
                    ),
                    bkt.ribbon.Button(
                        id="sticker_backup",
                        label = "BACKUP sticker",
                        screentip="Insert BACKUP sticker",
                        supertip="Insert a sticker shape in the top right of the current slide with the text BACKUP.",
                    ...
                    bkt.ribbon.Button(
                        ...
                        screentip="Insert FOR DISCUSSION sticker",
                        supertip="Insert a sticker shape in the top right of the current slide with the text FOR DISCUSSION.",
                        on_action=bkt.Callback(TextShapes.add_sticker_to_slides, slides=True, presentation=True, current_control=True),
                        tag="FOR DISCUSSION"
                    ),
                    bkt.ribbon.Button(
                        ...
                        screentip="Insert ILLUSTRATIVE sticker",
                        supertip="Insert a sticker shape in the top right of the current slide with the text ILLUSTRATIVE.",
                        on_action=bkt.Callback(TextShapes.add_sticker_to_slides, slides=True, presentation=True, current_control=True),
                        tag="ILLUSTRATIVE"
                    ),
                    bkt.ribbon.Button(
                        ...
                        screentip="Insert CONFIDENTIAL sticker",
                        supertip="Insert a sticker shape in the top right of the current slide with the text CONFIDENTIAL.",
                        on_action=bkt.Callback(TextShapes.add_sticker_to_slides, slides=True, presentation=True, current_control=True),
                        tag="CONFIDENTIAL"
                    ),
                    ...
                    bkt.ribbon.Button(
                        ...
                        screentip="Insert self-defined sticker",
                        supertip="Insert a sticker shape in the top right of the current slide with a self-defined text.",
                    ...
                    bkt.ribbon.Button(
                        id="sticker_own_edit",
                        label = "Change sticker text",
                        screentip="Edit self-defined sticker",
                        supertip="Change the text of the self-defined sticker and insert it immediately.",
                        on_action=bkt.Callback(TextShapes.own_sticker_edit, slides=True, presentation=True)
                    ),
                    bkt.ribbon.MenuSeparator(),
                    bkt.ribbon.Menu(
                        label="Alignment",
                        supertip="Set alignment options for stickers",
                        children=[
                            bkt.ribbon.ToggleButton(
                                label="Left",
                                screentip="Sticker alignment left",
                                supertip="Sets the position for inserting the stickers to left.",
                            ...
                            bkt.ribbon.ToggleButton(
                                label="Center",
                                screentip="Sticker alignment center",
                                supertip="Sets the position for inserting the stickers to center.",
                            ...
                            bkt.ribbon.ToggleButton(
                                label="Right",
                                screentip="Sticker alignment right",
                                supertip="Sets the position for inserting the stickers to right.",
                    ...
                    bkt.ribbon.Menu(
                        label="Font size",
                        supertip="Set font-size options for stickers",
                        children=[
                            bkt.ribbon.ToggleButton(
                                label="10",
                                screentip="Sticker font size 10",
                                supertip="Sets the font size for inserting the stickers to 10",
                            ...
                            bkt.ribbon.ToggleButton(
                                label="11",
                                screentip="Sticker font size 11",
                                supertip="Sets the font size for inserting the stickers to 11",
                            ...
                            bkt.ribbon.ToggleButton(
                                label="12",
                                screentip="Sticker font size 12",
                                supertip="Sets the font size for inserting the stickers to 12",
                            ...
                            bkt.ribbon.ToggleButton(
                                label="14",
                                screentip="Sticker font size 14",
                                supertip="Sets the font size for inserting the stickers to 14",
