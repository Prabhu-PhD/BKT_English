...
reference_menu = lambda: bkt.ribbon.Menu(
                xmlns="http://schemas.microsoft.com/office/2009/07/customui",
                id=None, 
                children=[
                        bkt.ribbon.ToggleButton(
                            label="Selected shape (default)",
                            supertip="The reference for all linked shapes is the currently selected shape",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="First shape in the slide deck",
                            supertip="The entire presentation is scanned for linked shapes and the first associated shape in the slide deck is set as the reference.",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Last shape in the slide deck",
                            supertip="The entire presentation is scanned for linked shapes and the last associated shape in the slide deck is set as the reference.",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Create status overlays",
                            supertip="Places a traffic-light status overlay on the selected shape that indicates whether the operation was successful and shapes were updated. Works for matching size, position, formatting and text.",
...
action_menu = lambda: bkt.ribbon.Menu(
                xmlns="http://schemas.microsoft.com/office/2009/07/customui",
                id=None, 
                children=[
                        bkt.ribbon.Button(
                            ...
                            screentip="Bring linked shapes to front",
                            supertip="Bring all linked shapes to front",
                        ...
                        bkt.ribbon.Button(
                            ...
                            screentip="Send linked shapes to back",
                            supertip="Send all linked shapes to back",
                        ...
                        bkt.ribbon.Button(
                            ...
                            screentip="Flip linked shapes horizontally",
                            supertip="Flip all linked shapes horizontally",
                        ...
                        bkt.ribbon.Button(
                            ...
                            screentip="Flip linked shapes vertically",
                            supertip="Flip all linked shapes vertically",
                            on_action=bkt.Callback(LinkedShapes.linked_shapes_flipv, shapes=True, context=True),
                        ),
                        bkt.ribbon.MenuSeparator(),
                        bkt.ribbon.Button(
                            id = 'linked_shapes_slidenum',
                            label="Insert slide number",
                            image_mso="NumberInsert",
                            screentip="Append an updatable slide number to linked shapes",
                            supertip="Automatically appends an updatable slide number at the end of the text to all linked shapes",
                            on_action=bkt.Callback(LinkedShapes.linked_shapes_slidenum, shapes=True, context=True),
                        ),
                        bkt.ribbon.Menu(
                            id='linked_shapes_changecase',
                            label="Change case",
                            supertip="Adjust the case for all linked shapes",
                            image_mso="ChangeCaseGallery",
                            children=[
                                bkt.ribbon.Button(
                                    id = 'linked_shapes_changecase-1',
                                    label="Capitalize the first letter of the sentence",
                                    supertip="Capitalize the first letter of the sentence for all linked shapes",
                                ...
                                bkt.ribbon.Button(
                                    ...
                                    label="lowercase",
                                    supertip="Lowercase the text of all linked shapes",
                                ...
                                bkt.ribbon.Button(
                                    ...
                                    label="UPPERCASE",
                                    supertip="Capitalize the text of all linked shapes",
                                ...
                                bkt.ribbon.Button(
                                    ...
                                    supertip="Capitalize the first letter of the word for all linked shapes",
                                ...
                                bkt.ribbon.Button(
                                    ...
                                    label="Invert case",
                                    supertip="Invert the case of all linked shapes",
...
properties_menu = lambda: bkt.ribbon.Menu(
                xmlns="http://schemas.microsoft.com/office/2009/07/customui",
                id=None, 
                children=[
                        bkt.ribbon.Button(
                            id = 'linked_shapes_custom-text',
                            label="Text (without formatting)",
                            screentip="Match text (without formatting)",
                            # image_mso="TextBoxInsert",
                            supertip="Match text without formatting for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            screentip="Match aspect-ratio lock",
                            # image_mso="ObjectBringToFront",
                            supertip="Match toggle lock aspect ratio for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Rotation",
                            screentip="Match rotation",
                            # image_mso="ObjectBringToFront",
                            supertip="Match rotation for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            screentip="Match black-and-white mode",
                            # image_mso="ObjectBringToFront",
                            supertip="Match black-and-white mode for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Left side",
                            screentip="Match left side",
                            # image_mso="ObjectBringToFront",
                            supertip="Match left side for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Right side",
                            screentip="Match right side",
                            # image_mso="ObjectBringToFront",
                            supertip="Match right side for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Top side",
                            screentip="Match top side",
                            # image_mso="ObjectBringToFront",
                            supertip="Match top side for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Bottom side",
                            screentip="Match bottom side",
                            # image_mso="ObjectBringToFront",
                            supertip="Match bottom side for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Center point left",
                            screentip="Match center point left",
                            # image_mso="ObjectBringToFront",
                            supertip="Match center point left for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Center point top",
                            screentip="Match center point top",
                            # image_mso="ObjectBringToFront",
                            supertip="Match center point top for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Width",
                            # image_mso="ObjectBringToFront",
                            supertip="Match width for all linked shapes",
                        ...
                        bkt.ribbon.Button(
                            ...
                            label="Height",
                            # image_mso="ObjectBringToFront",
                            supertip="Match height for all linked shapes",
