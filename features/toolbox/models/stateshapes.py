...
class LikertScaleGallery(bkt.ribbon.Gallery):
    ...
    def __init__(self, **kwargs):
        ...
        my_kwargs = dict(
            ...
            screentip="Insert Likert scale as toggle shape",
            supertip="Insert a Likert scale as a toggle shape. The fill level and the colors can be changed via the toggle-shape functions.",
...
class CheckBoxGallery(bkt.ribbon.Gallery):
    ...
    def __init__(self, **kwargs):
        ...
        my_kwargs = dict(
            ...
            screentip='Create checkbox',
            supertip="Insert a checkbox symbol as a toggle shape that can be changed interactively.",
