...
sprachen_gruppe = bkt.ribbon.Group(
    ...
    children=[
        ...
        bkt.ribbon.DialogBoxLauncher(
            label="Edit selectable languages…",
            supertip="Opens a dialog to change the selectable languages.",
...
sprachen_menu = bkt.ribbon.SplitButton(
    ...
    children=[
        bkt.ribbon.Button(
            ...
            image_mso='GroupLanguage',
            supertip="Shows a dialog to select the language to apply to the presentation or the selected slides.",
            on_action=bkt.Callback(LangSetter.show_lang_dialog)
        ),
        bkt.ribbon.Menu(
            label="Change language",
            supertip="Adjust the spell-check language for multiple shapes, slides or the entire presentation",
            image_mso="GroupLanguage",
            children=[
                bkt.ribbon.MenuSeparator(title="Change the language of shapes or slides"),
                bkt.ribbon.Button(
