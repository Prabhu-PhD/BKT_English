...
menus = [
    PPTSymbolsGallery(label="Page 1 ({})".format(len(fabric_symbols1)), symbols=fabric_symbols1, columns=16),
    PPTSymbolsGallery(label="Page 2 ({})".format(len(fabric_symbols2)), symbols=fabric_symbols2, columns=16),
    PPTSymbolsGallery(label="Page 3 ({})".format(len(fabric_symbols3)), symbols=fabric_symbols3, columns=16),
    PPTSymbolsGallery(label="Page 4 ({})".format(len(fabric_symbols4)), symbols=fabric_symbols4, columns=16),
