...
menus = [
    PPTSymbolsGallery(label="Page 1 ({})".format(len(symbols1)), symbols=symbols1, columns=16),
    PPTSymbolsGallery(label="Page 2 ({})".format(len(symbols2)), symbols=symbols2, columns=16)
]
