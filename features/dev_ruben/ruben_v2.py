...
group_copy_paste_style = bkt.ribbon.Group(
    label="Copy Style",
    children=[
        bkt.ribbon.Button(label='copy', screentip='copy image settings: crop position, ...', 
            on_action=bkt.Callback(copy_paste_style.copy_style),
            #get_enabled=bkt.Callback(copy_paste_style.image_selected)
        ),
        bkt.ribbon.Button(label='paste', screentip='paste image settings: crop position, ...',
...
group_meta_style = bkt.ribbon.Group(
	...
	children=[
		...
		bkt.ribbon.Button(label='Transfer style', show_label=True,
...
group_diverses = bkt.ribbon.Group(
    label="Misc.",
    children=[
        bkt.ribbon.Button(label="Black/white", show_label=True, on_action=bkt.Callback(Diverses.make_black_white)),
        ...
        bkt.ribbon.Button(label="White shadow", show_label=True, on_action=bkt.Callback(SolidShadow.solid_white_shadow)),
...
bkt.powerpoint.add_tab(
    bkt.ribbon.Tab(
        ...
        children=[
            bkt.ribbon.Group(
                label="Additional shapes",
                children = [
                    bkt.ribbon.Button(
                        id="rd_underline",
                        label='Underline', screentip='Add line to shape',
                        image_mso='Underline',
