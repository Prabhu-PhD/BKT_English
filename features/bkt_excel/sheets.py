...
class FileListOps(object):
    ...
    def file_list(cls, context, workbook, recursive=False, folders_only=False):
        ...
        fileDialog.title = "Select folder for file list"
...
blatt_gruppe = bkt.ribbon.Group(
    ...
    children=[
        bkt.ribbon.SplitButton(
            ...
            children=[
                bkt.ribbon.Button(
                    ...
                    label="Show/hide sheets",
                    show_label=True,
                    image_mso='SheetInsert',
                    #image="toggle_hidden_sheets",
                    supertip="Toggle all hidden sheets between shown and hidden.\n\nIf no sheets are hidden, the selected sheets or the current sheet are hidden.",
                ...
                bkt.ribbon.Menu(children=[
                    ...
                    bkt.ribbon.Button(
                        ...
                        label="Show/hide sheets (xlVeryHidden)",
                        show_label=True,
                        #image_mso='CreateQueryFromWizard',
                        supertip="Toggle all very hidden (xlVeryHidden) sheets between shown and hidden.\n\nIf no sheets are hidden, the selected sheets or the current sheet are hidden.",
                        on_action=bkt.Callback(SheetsOps.toggle_veryhidden_sheets, sheets=True, selected_sheets=True),
                        get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                    ),
                    bkt.ribbon.MenuSeparator(title="Hide"),
                        bkt.ribbon.Button(
                            id = 'hide_sheets',
                            label="Hide sheet",
                            show_label=True,
                            #image_mso='CreateQueryFromWizard',
                            supertip="Hide the current sheet or the selected sheets.",
                            on_action=bkt.Callback(SheetsOps.hide_sheets, selected_sheets=True),
                            get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                        ),
                        bkt.ribbon.Button(
                            id = 'hide_sheets_veryhidden',
                            label="Make sheet very hidden (xlVeryHidden)",
                            show_label=True,
                            #image_mso='CreateQueryFromWizard',
                            supertip="Make the current sheet or the selected sheets very hidden (xlVeryHidden) so they can only be made visible again via the toolbox or a macro.",
                            on_action=bkt.Callback(SheetsOps.hide_sheets_veryhidden, selected_sheets=True),
                            get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                        ),
                    bkt.ribbon.MenuSeparator(title="Show"),
                    bkt.ribbon.Button(
                        id = 'show_sheets_dialog',
                        label="Show sheets…",
                        show_label=True,
                        #image_mso='CreateQueryFromWizard',
                        supertip="Shows a selection of all hidden and very hidden sheets that can be selected for display.",
                        on_action=bkt.Callback(SheetsOps.show_sheets_dialog, workbook=True, sheets=True),
                        get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                    ),
                    bkt.ribbon.Button(
                        id = 'show_hidden_sheets',
                        label="Show all hidden sheets",
                        show_label=True,
                        #image_mso='QueryMakeTable',
                        supertip="Show all hidden sheets again.",
                        on_action=bkt.Callback(SheetsOps.show_hidden_sheets, sheets=True),
                        get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                    ),
                    bkt.ribbon.Button(
                        id = 'show_veryhidden_sheets',
                        label="Show all very hidden sheets (xlVeryHidden only)",
                        show_label=True,
                        #image_mso='QueryMakeTable',
                        supertip="Show all hidden or very hidden (xlVeryHidden) sheets again.",
                        on_action=bkt.Callback(SheetsOps.show_veryhidden_sheets, sheets=True),
                        get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                    ),
                    bkt.ribbon.Button(
                        id = 'show_all_sheets',
                        label="Show all sheets (incl. xlVeryHidden)",
                        show_label=True,
                        #image_mso='QueryMakeTable',
                        supertip="Show all hidden or very hidden (xlVeryHidden) sheets again.",
        ...
        bkt.ribbon.Menu(
            ...
            #image="list_sheets",
            screentip="Create various lists",
            supertip="List of all sheets, workbooks, file list, ...",
            children=[
                bkt.ribbon.MenuSeparator(title="Lists for the sheet"),
                bkt.ribbon.Button(
                    id = 'list_comments',
                    label="List of all comments",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all comments of the current sheet in a new sheet.",
                    on_action=bkt.Callback(SheetsOps.list_comments, sheet=True, workbook=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'list_cond_formats',
                    label="List of all conditional formats",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all conditional formats of the current sheet in a new sheet.",
                    on_action=bkt.Callback(SheetsOps.list_cond_formats, sheet=True, workbook=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'list_validations',
                    label="List of all data validations",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all data validations of the current sheet in a new sheet.",
                    on_action=bkt.Callback(SheetsOps.list_validations, sheet=True, workbook=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.MenuSeparator(title="Lists for the workbook"),
                bkt.ribbon.Button(
                    id = 'list_names',
                    label="List of all names",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all names of this workbook in a new sheet.",
                    on_action=bkt.Callback(SheetsOps.list_names, workbook=True, sheets=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'list_sheets',
                    label="List of all worksheets",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all sheets of this workbook in a new sheet.",
                    on_action=bkt.Callback(SheetsOps.list_sheets, workbook=True, sheets=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'list_properties',
                    label="List of all document properties",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all document properties of this workbook in a new sheet.",
                    on_action=bkt.Callback(SheetsOps.list_properties, workbook=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'list_workbooks',
                    label="List of all open workbooks",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all open workbooks incl. path in a new sheet.",
                    on_action=bkt.Callback(SheetsOps.list_workbooks, workbook=True, application=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.MenuSeparator(title="File lists"),
                bkt.ribbon.Button(
                    id = 'file_list',
                    label="Create file list…",
                    show_label=True,
                    image_mso='FileVersionHistory',
                    supertip="Choose a folder and create a list of all files in this folder in a new sheet.",
                ...
                bkt.ribbon.Button(
                    ...
                    label="Create file list (recursive)…",
                    show_label=True,
                    #image_mso='FileVersionHistory',
                    supertip="Choose a folder and create a list of all files in this folder and all subfolders in a new sheet.",
                    on_action=bkt.Callback(FileListOps.file_list_resursive, context=True, workbook=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'file_list_folders',
                    label="Create folder list (recursive)…",
                    show_label=True,
                    #image_mso='FileVersionHistory',
                    supertip="Choose a folder and create a list of all folders in this folder and all subfolders in a new sheet.",
                    on_action=bkt.Callback(FileListOps.file_list_folders, context=True, workbook=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.MenuSeparator(),
                bkt.ribbon.Menu(
                    label="File list settings",
                    children=[
                        bkt.ribbon.ToggleButton(
                            label="Folder rows",
                            screentip="In the file list, also insert folders as rows",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Group",
                            screentip="Group each hierarchy level (recursive only)",
                        ...
                        bkt.ribbon.ToggleButton(
                            label="Indent",
                            screentip="Indent each hierarchy level (recursive only)",
        ...
        bkt.ribbon.Menu(
            ...
            size="large",
            image_mso='Rename',
            screentip="Rename, sort or recreate multiple sheets",
            supertip="Rename multiple worksheets according to a selection or create from a template",
            children=[
                bkt.ribbon.Button(
                    id = 'sheets_base_list',
                    label="Create base list",
                    show_label=True,
                    #image_mso='SheetInsert',
                    supertip="Creates a list of all sheets of this workbook in a new sheet.",
                ...
                bkt.ribbon.Button(
                    ...
                    label="Rename sheets according to the current selection",
                    show_label=True,
                    #image_mso='Rename',
                    supertip="Rename all sheets according to the selection. The selection must consist of exactly 2 columns, where the first column contains the old name and the second column the new name. Empty names are skipped.",
                    on_action=bkt.Callback(SheetsOps.rename_all_sheets, workbook=True, areas=True, areas_max=1, application=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'sort_all_sheets',
                    label="Sort sheets according to the current selection",
                    show_label=True,
                    #image_mso='Rename',
                    supertip="Sort all sheets according to the selection. The selection must consist of exactly one column with the sheet names in the desired order.",
                    on_action=bkt.Callback(SheetsOps.sort_all_sheets, sheet=True, workbook=True, areas=True, areas_max=1, application=True),
                    get_enabled = bkt.CallbackTypes.get_enabled.dotnet_name,
                ),
                bkt.ribbon.Button(
                    id = 'create_sheets',
                    label="Create sheets according to the current selection",
                    show_label=True,
                    #image_mso='Rename',
                    supertip="Create new sheets according to the current selection. The selection must consist of exactly one column with the sheet names to be created.",
