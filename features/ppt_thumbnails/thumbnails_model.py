...
context_settings = lambda: bkt.ribbon.Menu(
                ...
                id=None, 
                children=[
                    bkt.ribbon.MenuSeparator(title="Quality"),
                    bkt.ribbon.CheckBox(
                    ...
                    bkt.ribbon.MenuSeparator(title="Content"),
                    bkt.ribbon.CheckBox(
                    ...
                    bkt.ribbon.MenuSeparator(title="Size"),
                    bkt.ribbon.Button(
...
context_reference = lambda: bkt.ribbon.Menu(
                ...
                children=[
                    bkt.ribbon.Button(
                        ...
                        label="Open",
                        supertip="Open the referenced file and select the thumbnail slide.",
                    ...
                    bkt.ribbon.Button(
                        ...
                        label="Replace file…",
                        supertip="Opens a file selection dialog to replace the referenced file. The file must contain the same slide ID.",
                        on_action=bkt.Callback(Thumbnailer.replace_file_ref, shape=True, application=True),
                    ),
                    bkt.ribbon.Button(
                        id='context-thumbnail-replaceref',
                        label="Overwrite",
                        supertip="Replace current slide reference with the copied slide from the clipboard.",
                    ...
                    bkt.ribbon.Button(
                        ...
                        label="Delete",
                        supertip="Delete the slide reference and thereby convert the thumbnail into a normal image.",
