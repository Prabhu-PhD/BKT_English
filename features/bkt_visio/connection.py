...
verbindungspunkte_gruppe = bkt.ribbon.Group(
    ...
    children=[
        bkt.ribbon.Box(box_style="vertical",
            children=[
                # bkt.ribbon.Button(
                    ...
                    # label="Copy master connection points to all",
                    # show_label=True,
                    # image_mso='HappyFace',
                    # screentip="Copy all connection points of the master shape (thick border) to other shapes",
                ...
                bkt.ribbon.Button(
                    ...
                    show_label=True,
                    image_mso='Copy',
                    screentip="Copy all connection points of the selected shape",
                ...
                bkt.ribbon.Button(
                    ...
                    show_label=True,
                    image_mso='Paste',
                    screentip="Insert copied connection points into selected shapes",
                ...
                bkt.ribbon.Button(
                    ...
                    show_label=True,
                    image_mso='Delete',
                    screentip="Remove all connection points of the selected shapes",
        ...
        bkt.ribbon.Box(box_style="vertical",
            children=[
                bkt.ribbon.Menu(
                    label='Create new points',
                    screentip='Selection of connection points',
                    supertip='Create a prefabricated standard selection of connection points',
                    show_label=True,
                    image_mso='ConnectionPointTool',
                    children = [
                        #bkt.ribbon.MenuSeparator(title="Connection points"),
                        bkt.ribbon.Button(
                            id = 'add_con_pts_edges',
                            image = 'conpts_edges',
                            label='In the 4 corners',
                            show_label=True,
                ...
                bkt.ribbon.Button(
                    id = 'make_unglueable',
                    label="Shape non-sticky",
                    show_label=True,
                    image_mso='SnapToggle',
                    screentip="Make shape non-sticky",
                    supertip="Makes a shape non-sticky for connectors and other shapes via the ShapeSheet properties GlueType, ObjType and IsSnapTarget (groups only).",
                ...
                bkt.ribbon.SplitButton(
                    children=[
                        bkt.ribbon.Button(
                            ...
                            screentip="Make shape sticky",
                            supertip="Makes a shape sticky for connectors via the ShapeSheet properties GlueType, ObjType and IsSnapTarget (groups only).",
                        ...
                        bkt.ribbon.Menu(children=[
                            bkt.ribbon.Button(
                                ...
                                show_label=True,
                                #image_mso='GlueToggle',
                                screentip="Reset shape",
                                supertip="Resets the ShapeSheet properties GlueType, ObjType and IsSnapTarget (groups only) to default.",
