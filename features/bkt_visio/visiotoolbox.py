...
ablage_gruppe = bkt.ribbon.Group(
    ...
    children=[
        ...
        bkt.ribbon.Button(
            id = 'copy_on_target',
            label="Copy with coordinates",
            show_label=False,
            image_mso='Copy',
            screentip="Copy with coordinates",
            supertip="Shapes are copied with their original coordinate positions",
        ...
        bkt.ribbon.Button(
            id = 'paste_on_target',
            label="Insert at coordinates",
            show_label=False,
            image_mso='PasteAsNestedTable',
            screentip="Insert at coordinates",
            supertip="Shapes are inserted at their original coordinate positions",
