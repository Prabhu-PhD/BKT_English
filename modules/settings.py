...
class SettingsMenu(bkt.ribbon.DynamicMenu):
    def __init__(self, idtag="", **kwargs):
        ...
        if ((bkt.config.task_panes or False)):
            self.additional_children.append(
                ...
                supertip="Show/hide BKT task pane (sidebar)",
                tag='BKT Task Pane',
        ...
        super(SettingsMenu, self).__init__(
            ...
            supertip="Manage BKT settings, reload BKT, open website, etc.",
            **kwargs
        )
    ...
    def get_content(self):
        return bkt.ribbon.Menu(
                ...
                bkt.ribbon.Button(
                    ...
                    label="About {} v{}".format(bkt.__release__, bkt.__version__),
                    image_mso="Info",
                    supertip="Show extended version information",
                ...
                bkt.ribbon.SplitButton(
                    ...
                    children=[
                        bkt.ribbon.Button(
                            ...
                            screentip="Check for new version",
                            supertip="Check whether a new BKT version is available",
                            image_mso="ProductUpdates",
                            on_action=bkt.Callback(BKTUpdates.manual_check_for_updates)
                        ),
                        bkt.ribbon.Menu(
                            label="Check for new version options",
                            supertip="Settings for automatic check for new versions",
                            children=[
                                bkt.ribbon.Button(
                                    label="Check for new version now",
                                    supertip="Check whether a new BKT version is available",
                                    image_mso="ProductUpdates",
                                    on_action=bkt.Callback(BKTUpdates.manual_check_for_updates)
                                ),
                                ...
                                bkt.ribbon.MenuSeparator(title="Search automatically for a new version"),
                                bkt.ribbon.ToggleButton(
                                    label="Weekly",
                                    supertip="Automatically checks once per week at PowerPoint startup for a new BKT version",
                                    tag="weekly",
                                ...
                                bkt.ribbon.ToggleButton(
                                    label="Weekly, Fridays only",
                                    supertip="Automatically checks every Friday, but at the latest after 31 days, at PowerPoint startup for a new BKT version",
                                    tag="friday-only",
                                    get_pressed=bkt.Callback(BKTUpdates.get_check_frequency, current_control=True),
                                    on_toggle_action=bkt.Callback(BKTUpdates.change_check_frequency, current_control=True),
                                ),
                                bkt.ribbon.ToggleButton(
                                    label="Monthly",
                                    supertip="Automatically checks once per month at PowerPoint startup for a new BKT version",
                                    tag="monthly",
                                    get_pressed=bkt.Callback(BKTUpdates.get_check_frequency, current_control=True),
                                    on_toggle_action=bkt.Callback(BKTUpdates.change_check_frequency, current_control=True),
                                ),
                                ...
                                bkt.ribbon.ToggleButton(
                                    label="Nie",
                                    supertip="Disable automatic search for a new BKT version",
                                    tag="never",
                                    get_pressed=bkt.Callback(BKTUpdates.get_check_frequency, current_control=True),
                                    on_toggle_action=bkt.Callback(BKTUpdates.change_check_frequency, current_control=True),
                                ),
                ...
                bkt.ribbon.Button(
                    ...
                    supertip="Open BKT website in browser",
                ...
                bkt.ribbon.Button(
                    ...
                    supertip="Show presentation with the version changes",
                ...
                bkt.ribbon.DynamicMenu(
                    ...
                    supertip="Add or remove feature folder",
                ...
                bkt.ribbon.Button(
                    ...
                    label="Reload add-in",
                    supertip="Quit and reload BKT add-in (similar to a PowerPoint restart)",
                ...
                bkt.ribbon.Button(
                    ...
                    supertip="Refresh the interface and reload all values (so-called Invalidate)",
                    image_mso="AccessRefreshAllLists",
                ...
                bkt.ribbon.Button(
                    ...
                    supertip="Open folder with BKT framework and configuration file",
                    image_mso="Folder",
                ...
                bkt.ribbon.Button(
                    ...
                    supertip="Open configuration file in the default editor",
                ...
                bkt.ribbon.ToggleButton(
                    ...
                    label='Toggle key/mouse hooks',
                    supertip="Toggle keyboard/mouse events for the current session",
    ...
    def info_delete_button_for_folder(self, label, folder):
        return bkt.ribbon.Button(
            label=label,
            supertip="Remove feature folder »{}« from BKT configuration".format(folder),
        ...
        return bkt.ribbon.Menu(
            ...
            children=[
                bkt.ribbon.Button(
                    ...
                    label='Add feature folder',
                    supertip="Select and add a BKT feature folder",
                    image_mso='ModuleInsert',
